...
def _load_data():
    ...
    merged["weak_subjects"] = merged["weak_subjects"].apply(
        parse_ws
    )
...
def _get_rec_fn():
    spec = importlib.util.spec_from_file_location(
        "recommendations",
        NOTEBOOKS_DIR / "recommendations.py",
    )
